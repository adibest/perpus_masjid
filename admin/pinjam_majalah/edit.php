              ...
              <div class="box-body">
                ...
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="inputEmail3" class="col-sm-2 control-label">Majalah</label>
                      <div class="col-sm-10"> 
                        <select class="form-control" name="issn">
                          <?php while($data2 = mysqli_fetch_assoc($hasil2)) {?>
                            <?php if($data2['issn']==$row['issn']){?>
                              <option value="<?php echo $data2['issn']; ?>" selected><?php echo $data2['judul_majalah']; ?></option>
                            <?php }else {?>
