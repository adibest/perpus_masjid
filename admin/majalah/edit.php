                  ...
                  <div class="col-sm-10"> 
                    <select class="form-control" name="id_rak_majalah">
                      <?php while($data2 = mysqli_fetch_assoc($hasil2)) {?>
                        <?php if($data2['id_rak_majalah']==$row['id_rak_majalah']){?>
                          <option value="<?php echo $data2['id_rak_majalah']; ?>" selected><?php echo $data2['nama_rak_majalah']; ?></option>
                        <?php }else {?>
                  ...
                  <div class="col-sm-10"> 
                    <select class="form-control" name="id_kategori_majalah">
                      <?php while($data3 = mysqli_fetch_assoc($hasil3)) {?>
                        <?php if($data3['id_kategori_majalah']==$row['id_kategori_majalah']){?>
                          <option value="<?php echo $data3['id_kategori_majalah']; ?>" selected><?php echo $data3['nama_kategori_majalah']; ?></option>
                        <?php }else {?>
