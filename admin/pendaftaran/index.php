      ...
      <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                ...
                <a href="http://localhost/perpus_masjid/admin/pendaftaran/create.php" class="btn btn-primary pull-right">Create</a>
...
<tr>
  ...
  <td><?= $row['id_anggota'] // id_anggota($row['id_anggota'])?></td>
