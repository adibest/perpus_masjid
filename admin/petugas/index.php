      ...
      <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                ...
                <a href="http://localhost/perpus_masjid/admin/petugas/create.php" class="btn btn-primary pull-right <?php if($_SESSION['id_petugas']==2){echo "disabled";} else{echo "";}?>">Create</a>
...
<tr>
  ...
  <td>
    <a href='edit.php?id=<?= $row['id_petugas'] ?>' class='btn btn-primary btn-xs <?php if($_SESSION['id_petugas']==2){echo "disabled";} else{echo "";}?>'>Edit</a>
    <a href='delete.php?id=<?= $row['id_petugas'] ?>'onclick='javascript:return confirm(\"Apakah anda yakin ingin menghapus data ini?\")' class='btn btn-danger btn-xs <?php if($_SESSION['id_petugas']==2){echo "disabled";} else{echo "";}?>'>Hapus</a>
  </td>
</tr>
<?php
  }
