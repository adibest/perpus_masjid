    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Admin</b>LIB</span>
        </a>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10"> 
                      <select class="form-control" name="id_anggota">
                        <?php while($data = mysqli_fetch_assoc($hasil)) {?>
                          <?php if($data['id_anggota']==$row['id_anggota']){?>
                            <option value="<?php echo $data['id_anggota']; ?>" selected><?php echo $data['nama_anggota']; ?></option>
                          <?php }else {?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10"> 
                        <select class="form-control" name="isbn">
                          <?php while($data2 = mysqli_fetch_assoc($hasil2)) {?>
                            <?php if($data2['isbn']==$row['isbn']){?>
                              <option value="<?php echo $data2['isbn']; ?>" selected><?php echo $data2['judul_buku']; ?></option>
                            <?php }else {?>
                              <option value="<?php echo $data2['isbn']; ?>"><?php echo $data2['judul_buku']; ?></option>
                            <?php }} ?>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10"> 
                          <select class="form-control" name="status_pinjam_buku">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10"> 
                          <select class="form-control" name="id_petugas">
                            <?php while($data = mysqli_fetch_assoc($hasil3)) {?>
                              <?php if($data['id_petugas']==$row['id_petugas']){?>
                                <option value="<?php echo $data['id_petugas']; ?>" selected><?php echo $data['nama_petugas']; ?></option>
                              <?php }else {?>
